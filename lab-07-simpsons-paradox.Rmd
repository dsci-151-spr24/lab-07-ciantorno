...
***This data was from an observational study because there were no assigned treatment groups for people.***

2.  How many observations are in this dataset?
    What does each observation represent?
    
***There are `r nrow(Whickham)` observations in this dataset.  Each observation represents one particular woman in in the study.***
...
***This does not meet what I thought would happen, since it shows that those who have smoked have a higher probability of being alive 20 years later.***
...
***In the first visualization before the data was split up into age groups, it appeared as though more smokers were alive than non-smokers.  In faceting the data by age category, it now appeared that more non-smokers were alive than smokers.***
